...
parser.add_argument('--output_folder', type=str, default="data/results/preprocessed_all_filtered_feed/",
...
parser.add_argument('--filter_feed', action='store_true', default=True,
